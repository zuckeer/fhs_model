# Criando a estrutura pra usar o modelo salvo
import streamlit as st
import joblib
import pandas as pd

# Criando a pagina usando streamlit
st.write("# 10 Year Heart Disease Prediction")
col1, col2, col3 = st.columns(3)

# Definição de estilo para o HTML
st.markdown("""
<style>
.big-font {
...
# Criando o objeto para o resultado
...
# Preparando a input
df_pred = pd.DataFrame([[gender, age, education, isSmoker, yearsSmoking, \
    BPMeds, stroke, hyp, diabetes, chol, sys_bp, dia_bp, bmi, heart_rate, glucose]], \
